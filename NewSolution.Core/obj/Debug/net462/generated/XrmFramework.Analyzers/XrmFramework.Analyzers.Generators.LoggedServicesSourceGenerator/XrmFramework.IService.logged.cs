...
namespace XrmFramework
{
    ...
    public class LoggedIService : LoggedServiceBase, IService
    {
        ...
        public global::System.Guid Create(global::Microsoft.Xrm.Sdk.Entity entity, bool useAdmin, bool bypassCustomPluginExecution)
        {
        ...
        public global::Microsoft.Xrm.Sdk.Messages.UpsertResponse Upsert(global::Microsoft.Xrm.Sdk.Entity entity, bool useAdmin, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            if (entity == default)
            {
        ...
        public void Update(global::Microsoft.Xrm.Sdk.Entity entity, bool useAdmin, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            if (entity == default)
            {
        ...
        public void Delete(string logicalName, global::System.Guid id, bool useAdmin, bool bypassCustomPluginExecution)
        {
            #region Parameters check
        ...
        public global::System.Guid Create(global::Microsoft.Xrm.Sdk.Entity entity, global::System.Guid callerId, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            if (entity == default)
            {
        ...
        public global::Microsoft.Xrm.Sdk.Messages.UpsertResponse Upsert(global::Microsoft.Xrm.Sdk.Entity entity, global::System.Guid callerId, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            if (entity == default)
            {
        ...
        public void Update(global::Microsoft.Xrm.Sdk.Entity entity, global::System.Guid callerId, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            if (entity == default)
            {
        ...
        public void Delete(string logicalName, global::System.Guid id, global::System.Guid callerId, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            if (string.IsNullOrWhiteSpace(logicalName))
            {
        ...
        public void Delete(global::Microsoft.Xrm.Sdk.EntityReference objectReference, bool useAdmin, bool bypassCustomPluginExecution)
        {
            #region Parameters check
        ...
        public void Delete(global::Microsoft.Xrm.Sdk.EntityReference objectReference, global::System.Guid callerId, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            if (objectReference == default)
            {
        ...
        public void AssignEntity(global::Microsoft.Xrm.Sdk.EntityReference objectReference, global::Microsoft.Xrm.Sdk.EntityReference ownerRef, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            if (objectReference == default)
            {
        ...
        public void AddToQueue(global::System.Guid queueId, global::Microsoft.Xrm.Sdk.EntityReference target, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            if (queueId == default)
            {
        ...
        public void Merge(global::Microsoft.Xrm.Sdk.EntityReference target, global::System.Guid subordonate, global::Microsoft.Xrm.Sdk.Entity content, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            if (target == default)
            {
        ...
        public void SetState(global::Microsoft.Xrm.Sdk.EntityReference objectRef, int stateCode, int statusCode, bool useAdmin, bool bypassCustomPluginExecution)
        {
            #region Parameters check
        ...
        public void Share(global::Microsoft.Xrm.Sdk.EntityReference objectRef, global::Microsoft.Xrm.Sdk.EntityReference assignee, global::Microsoft.Crm.Sdk.Messages.AccessRights accessRights, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            if (objectRef == default)
            {
        ...
        public void UnShare(global::Microsoft.Xrm.Sdk.EntityReference objectRef, global::Microsoft.Xrm.Sdk.EntityReference revokee, global::Microsoft.Xrm.Sdk.EntityReference callerRef, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            if (objectRef == default)
            {
        ...
        public T GetById<T>(global::System.Guid id) where T : global::XrmFramework.BindingModel.IBindingModel, new()
        {
            #region Parameters check
            if (id == default)
            {
        ...
        public T GetById<T>(global::Microsoft.Xrm.Sdk.EntityReference entityReference) where T : global::XrmFramework.BindingModel.IBindingModel, new()
        {
            #region Parameters check
        ...
        public T Upsert<T>(T model, bool isAdmin, bool bypassCustomPluginExecution) where T : global::XrmFramework.BindingModel.IBindingModel, new()
        {
            #region Parameters check
        ...
        public global::Microsoft.Xrm.Sdk.Entity ToEntity<T>(T model) where T : global::XrmFramework.BindingModel.IBindingModel
        {
            #region Parameters check
            if (Equals(model, default(T)))
            {
        ...
        public void AddRoleToUserOrTeam(global::Microsoft.Xrm.Sdk.EntityReference userOrTeamRef, string parentRootRoleIdOrTemplateId, bool bypassCustomPluginExecution)
        {
            #region Parameters check
            ...
            if (string.IsNullOrWhiteSpace(parentRootRoleIdOrTemplateId))
            {
